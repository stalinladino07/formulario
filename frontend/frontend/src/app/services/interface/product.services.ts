...
export class ProductService {
  ...
  public updateProducts(obj: any): Observable<any> {
    return  this._genericService.genericCallServices('put', `${this.url.CONTEXT}${this.url.CONTEXT_PRODUCT}${this.url.PRODUCTS.UPDATE}${obj.idProduct}`, obj, null);
  }
